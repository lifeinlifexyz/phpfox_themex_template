                                    ...
                                    <div class="drop_data_user">
                                        ...
                                        <div class="dropdown extra_info_middot dropup" style="display:none;">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right">
                                                <li><a role="button" onclick="$Core.composeMessage({l}user_id: {$aFriend.user_id}{r}); return false;"><span class="icon-olymp-comment-icon"></span>{_p var='send_message'}</a></li>
