  ...
  <div class="activity_feed_form_share">
    ...
    <ul class="activity_feed_form_attach">
      ...
      <li><a href="#" rel="global_attachment_status" class="global_attachment_status active">
              <span class="icon-olymp-post-icon"></span>
        <div>
          {_p var='post'}
      ...
      <li><a href="#" rel="global_attachment_status" class="global_attachment_status active">
              <span class="icon-olymp-status-icon"></span>
        <div>
          {_p var='status'}<span class="activity_feed_link_form_ajax">user.updateStatus</span></div><div class="drop"></div></a></li>
      {else}
      <li><a href="#" rel="global_attachment_status" class="global_attachment_status active"><div><span class="icon-olymp-post-icon"></span>{_p var='post'}<span class="activity_feed_link_form_ajax">feed.addComment</span></div><div class="drop"></div></a></li>
      {/if}
      ...
      <li><a href="#" rel="view_more_link" class="timeline_view_more js_hover_title"><span class="js_hover_info">{_p var='load_more'}</span></a>
        <ul class="view_more_drop">
          ...
          <li>
            <a id="attachments_photo" href="#" rel="global_attachment_{$aFeedStatusLink.module_id}"{if $aFeedStatusLink.no_input} class="no_text_input"{/if}>
              <span class="icon-olymp-camera-icon"></span>
