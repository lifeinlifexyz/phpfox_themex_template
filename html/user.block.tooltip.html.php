	...
	<ul>
        ...
        <li class="item-tooltip-viewmore-button dropup">
            ...
            <ul class="dropdown-menu dropdown-menu-right">
                <li><a  href="#" onclick="$Core.composeMessage({left_curly}user_id: {$aUser.user_id}{right_curly});$(this).closest('.js_user_tool_tip_holder').hide(); return false;"><span class="icon-olymp-comment-icon"></span>{_p var='send_message'}</a></li>
            </ul>
        </li>
        {/if}
		{else}
